...
rp_module_id="xemu"
rp_module_desc="** Xbox Emulator ** READ THE HELP BEFORE STARTING EMULATOR **"
rp_module_help="**Note** Once installed BEFORE you start xemu you require 3 further files.\nhttps://xemu.app/docs/required-files/\nBootrom   : mcpx_1.0.bin\nFlashrom  : complex.bin\nHHD Image : xbox_hdd.qcow2\nPlace files in /home/pi/.local/share/xemu/xemu\nROM Extensions: .xiso.iso \nConvert your Xbox .iso files to .xiso files\nhttps://xemu.app/docs/disc-images/\nuse the PACK function on xdvdfs\nCopy your Xbox games to /home/pi/RetroPie/roms/xbox and load/run them from there"
...
function configure_xemu() {
    ...
    addEmulator 0 "$md_id" "xbox" "XINIT-WM:LIBGL_ALWAYS_SOFTWARE=true $md_inst/xemu -config_path /home/pi/.local/share/xemu/xemu/ -dvd_path %ROM%"
    addEmulator 1 "$md_id-gui" "xbox" "XINIT-WM:LIBGL_ALWAYS_SOFTWARE=true $md_inst/xemu"
...
# Set Permissions on xemu.toml config file to allow xemu to save settings.
chmod 777 /home/pi/.local/share/xemu/xemu/xemu.toml
sudo chown pi:pi /home/pi/.local/share/xemu/xemu/xemu.toml
}
